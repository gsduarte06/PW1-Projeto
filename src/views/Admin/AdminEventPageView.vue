                      ...
                      <v-card class="elevation-0 rounded-lg" style="background-color: #00041f;">
                        <v-row>
                          <v-col cols="12" md="8"
                            ...
                            <p v-if="contentHour.speakers != null && Array.isArray(contentHour.speakers)" class="text-body2 text-white">
                              Speakers: {{ contentHour.speakers.join(", ") }}
                            </p>
                            <p v-else-if="contentHour.speakers != null" class="text-body2 text-white">
                              Speakers: {{ contentHour.speakers }}  <!-- In case speakers is a non-array object -->
                            </p>
                          </v-col>
                          <v-col cols="12" md="4">
