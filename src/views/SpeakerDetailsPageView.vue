  ...
  <div class="speaker-details" style="background-color: #00041f; color: white; padding: 20px;">
    <v-card style="background-color: #00041f; color: white; padding: 20px;">
      <div class="d-flex flex-row align-center">
        <!-- Speaker Image -->
        <img v-if="speaker?.image" :src="speaker.image" alt="Speaker Image" class="rounded-xl" style="
              width: 250px; 
              height: 250px; 
              margin-right: 30px; 
              box-shadow: 0 4px 20px rgba(0, 0, 0, 0.8);
            " />
        <img v-else src="https://via.placeholder.com/250" alt="Placeholder Image" class="rounded-xl" style="
              width: 250px; 
              height: 250px; 
              margin-right: 30px; 
              box-shadow: 0 4px 20px rgba(0, 0, 0, 0.8);
    ...
    <p class="text-body2" style="line-height: 1.8;">
